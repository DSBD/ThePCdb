...
namespace ThePCdb.AppCore
{
    public static class Warehouse
    {
        ...
        public static void loadPSU()
        {
            ...
            PSUList.Add(new Components.PSUPart("Cooler Master MasterWatt 550", 79.99, 0, "PSU", "421001", "SFX", 550, Components.PSUPart.EightyPlus.Bronze));
            PSUList.Add(new Components.PSUPart("Cooler Master MasterWatt 650", 89.99, 0, "PSU", "421002", "SFX", 650, Components.PSUPart.EightyPlus.Bronze));
            PSUList.Add(new Components.PSUPart("Cooler Master MasterWatt 750", 99.99, 0, "PSU", "421003", "ATX", 750, Components.PSUPart.EightyPlus.Bronze));
            ...
            PSUList.Add(new Components.PSUPart("Cooler Master MasterWatt Maker 1200 MIJ", 1399.99, 0, "PSU", "424001", "ATX", 1200, Components.PSUPart.EightyPlus.Titanium));
