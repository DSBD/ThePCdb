...
namespace ThePCdb.AppCore
{
    public static class Warehouse
    {
        ...
        public static void loadBuilds()
        {
            ...
            buildList.Add(generateBuildParts("633001", "0", "111006", "325003", "231004", "421001", "521003", "821001"));
            buildList.Add(generateBuildParts("621002", "711005", "111006", "325003", "231004", "421001", "511001", "821001"));
            buildList.Add(generateBuildParts("611004", "711005", "123005", "325003", "231004", "421002", "533001", "811001"));
            ...
            buildList.Add(generateBuildParts("641002", "722002", "112007", "312001", "212005", "413003", "524001", "831005"));
            buildList.Add(generateBuildParts("641002", "742002", "112005", "312001", "212002", "412002", "524001", "831004"));
        ...
        public static void loadMotherboards()
        {
            ...
            MotherboardList.Add(new Components.MotherboardPart("Asus ROG Strix X299-E Gaming", 439.99, 0, "Motherboard", "212005", "ATX", 8, 3, true, Components.CPUPart.Socket.LGA2066, Components.CPUPart.Chipset.X299));
        ...
        public static void loadPSU()
        {
            ...
            PSUList.Add(new Components.PSUPart("Cooler Master MasterWatt750", 99.99, 0, "PSU", "421003", "ATX", 750, Components.PSUPart.EightyPlus.Bronze));
            PSUList.Add(new Components.PSUPart("Cooler Master V650", 169.99, 0, "PSU", "422001", "ATX", 650, Components.PSUPart.EightyPlus.Gold));
            PSUList.Add(new Components.PSUPart("Cooler Master V750", 199.99, 0, "PSU", "422002", "ATX", 750, Components.PSUPart.EightyPlus.Gold));
            PSUList.Add(new Components.PSUPart("Cooler Master V850", 232.99, 0, "PSU", "422003", "ATX", 850, Components.PSUPart.EightyPlus.Gold));
            PSUList.Add(new Components.PSUPart("Cooler Master V1000", 319.99, 0, "PSU", "422004", "ATX", 1000, Components.PSUPart.EightyPlus.Gold));
            PSUList.Add(new Components.PSUPart("Cooler Master V1200 Platinum", 399.99, 0, "PSU", "423001", "ATX", 1200, Components.PSUPart.EightyPlus.Platinum));
            PSUList.Add(new Components.PSUPart("Cooler Master MasterWatt Maker V1200 MIJ", 1399.99, 0, "PSU", "424001", "ATX", 1200, Components.PSUPart.EightyPlus.Titanium));
